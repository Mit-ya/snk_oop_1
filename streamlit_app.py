...
# Pre‑defined track groups with actual indicators
DISEASE_TRACKS = {
    "physical": [
        "Оставленные на повторное обучение",
        "ОВЗ",
        "Инвалиды",
        "Инвалиды_дети-инвалиды",
        "Глухие",
        "Слабослышащие и позднШколаглохшие",
        "Слепые слабовидящие и позднШколаслепшие",
        "Слабовидящие и позднШколаслепшие",
        "С тяжелыми нарушениями речи",
        "С нарушением опорно-двигательного аппарата",
        "Глухие_слабослышащие",
        "Глухие_позднШколаглохшие",
        "Глухие_слепые",
        "Глухие_слабовидящие",
        "Глухие_с тяжелыми нарушениями речи",
        "Глухие_с нарушением опорно-двигательного аппарата",
        "Глухие_с иными ОВЗ",
        "С иными ОВЗ"
    ],
    "cognitive": [
        ...
        "Глухие_с задержкой психического развития",
        "Глухие_с умственной отсталостью (интеллектуальными нарушениями)",
        "С умственной отсталостью (интеллектуальными нарушениями)"
    ],
    "social": [
        "Дети-сироты, дети без попечения родителей",
        "Со сложными дефектами",
        "Сумма по классам с ОВЗ в составе"
    ],
    "all": [
        "Сумма по классам",
        "Воспитанников всего",
